...
def make_plots(bin_info):
    ...
    # generic-one_line_summary	generic-Complete	generic-Single copy	    generic-Multi copy	generic-Fragmented	generic-Missing	    generic-n_markers	generic-dataset_name	generic-creation_date	generic-number_of_busco_markers	    generic-number_of_species
