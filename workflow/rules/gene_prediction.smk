...
def get_genomes_for_gene_prediction(lineage):
    ...
    if lineage == 'bacteria':
        fasta_files = glob.glob("genomes/genomes/MAG_prokaryotic_*.fa")
    ...
    if lineage == 'eukaryote':
        fasta_files = glob.glob("genomes/genomes/MAG_eukaryotic_*.fa")
        if len(fasta_files) == 0:
    ...
    if lineage == 'virus':
        fasta_files = glob.glob("genomes/genomes/MAG_viral_*.fa")
        if len(fasta_files) == 0:
    ...
    if lineage == 'plasmid':
        fasta_files = glob.glob("genomes/genomes/MAG_plasmid_*.fa")
        if len(fasta_files) == 0:
