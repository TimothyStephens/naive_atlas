...
def main(args=None):
    ...
    usage = "{} -i <prokka_pep_1> <prokka_pep_2> -o <output_directory> -s <stats_file>".format(__program__)
    ...
    # Pipeline
    parser.add_argument("-i","--input_pep_files",  type=str, required=True, help="path/to/prokka_output_files/*.faa", nargs='*')
