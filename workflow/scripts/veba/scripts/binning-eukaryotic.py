...
"""%( 
            # Args
            os.path.join(os.environ["busco"].replace('/bin/busco', ''), "lib", "python3.8", "site-packages"),
...
def create_pipeline(opts, directories, f_cmds):
    ...
    if opts.bam is not None:
        ...
        input_filepaths = [ 
            opts.fasta,
            os.path.join(directories[("intermediate", "{}__busco".format(steps['busco']))], "filtered", "genomes", "*.gff"),
            *opts.bam,
        ]
    ...
    input_filepaths = [ 
        # BUSCO
        os.path.join(directories[("intermediate", "{}__busco".format(steps['busco']) )], "filtered", "identifier_mapping.metaeuk.tsv"),
        os.path.join(directories[("intermediate", "{}__busco".format(steps['busco']) )], "filtered", "genome_statistics.tsv"),
        os.path.join(directories[("intermediate", "{}__busco".format(steps['busco']) )], "filtered", "gene_statistics.cds.tsv"),
        os.path.join(directories[("intermediate", "{}__busco".format(steps['busco']) )], "filtered", "gene_statistics.rRNA.tsv"),
        os.path.join(directories[("intermediate", "{}__busco".format(steps['busco']) )], "filtered", "gene_statistics.tRNA.tsv"),
        os.path.join(directories[("intermediate", "{}__busco".format(steps['busco']) )], "filtered", "busco_results.filtered.tsv"),
        os.path.join(directories[("intermediate", "{}__busco".format(steps['busco']) )], "filtered", "scaffolds_to_bins.tsv"),
        os.path.join(directories[("intermediate", "{}__busco".format(steps['busco']) )], "filtered", "bins.list"),
        os.path.join(directories[("intermediate", "{}__busco".format(steps['busco']) )], "filtered", "binned.list"),
        os.path.join(directories[("intermediate", "{}__busco".format(steps['busco']) )], "filtered", "unbinned.list"),
        os.path.join(directories[("intermediate", "{}__busco".format(steps['busco']) )], "filtered", "unbinned.fasta"),
        os.path.join(directories[("intermediate", "{}__busco".format(steps['busco']) )], "filtered", "genomes"),
    ]
    
    if opts.bam:
        input_filepaths += [
            # featureCounts
            os.path.join(directories[("intermediate",  "{}__featurecounts".format(steps['featurecounts']) )], "featurecounts.orfs.tsv.gz"),
        ]
