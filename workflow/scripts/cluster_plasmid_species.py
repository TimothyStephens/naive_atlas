...
logging.info("Define Quality score defined as `plasmid_score`")
# recalulate quality score as some completeness might be recalibrated.
Q.eval("Quality_score = `plasmid_score`", inplace=True)
quality_score = Q.Quality_score

assert (
    not quality_score.isnull().any()
), "I have NA quality values for the quality score, it seems not all of the values defined in the quality_score_formula are present for all entries in tables/Genome_quality.tsv "
